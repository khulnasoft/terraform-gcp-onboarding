...
This Terraform module integrates an existing Google Cloud Platform (GCP) project with Khulnasoft Security.
...
| <a name="input_khulnasoft_api_secret"></a> [khulnasoft\_api\_secret](#input\_khulnasoft\_api\_secret) | Khulnasoft API secret | `string` | n/a | yes |
| <a name="input_khulnasoft_autoconnect_url"></a> [khulnasoft\_autoconnect\_url](#input\_khulnasoft\_autoconnect\_url) | Khulnasoft Autoconnect API URL | `string` | n/a | yes |
...
| <a name="input_khulnasoft_cspm_group_id"></a> [khulnasoft\_cspm\_group\_id](#input\_khulnasoft\_cspm\_group\_id) | Khulnasoft CSPM Group ID | `number` | n/a | yes |
| <a name="input_cspm_role_name"></a> [cspm\_role\_name](#input\_cspm\_role\_name) | The name of the role used for CSPM | `string` | `"KhulnasoftAutoConnectRole"` | no |
